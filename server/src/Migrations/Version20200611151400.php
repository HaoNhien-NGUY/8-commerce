 ...
 */
final class Version20200611151400 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE supplier_order_subproduct (id INT AUTO_INCREMENT NOT NULL, subproduct_id INT NOT NULL, supplier_order_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_7CF3E7C21A1581F9 (subproduct_id), INDEX IDX_7CF3E7C21605B9 (supplier_order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, sub_category_id INT NOT NULL, supplier_id INT NOT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, promo INT DEFAULT NULL, created_at DATETIME NOT NULL, clicks INT DEFAULT NULL, sex VARCHAR(255) DEFAULT NULL, status TINYINT(1) DEFAULT NULL, INDEX IDX_D34A04ADF7BFE87C (sub_category_id), INDEX IDX_D34A04AD2ADD6D8C (supplier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
