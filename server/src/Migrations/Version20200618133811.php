 ...
 */
final class Version20200618133811 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_order CHANGE user_id user_id INT DEFAULT NULL, CHANGE promo_code_id promo_code_id INT DEFAULT NULL');
