 ...
 */
final class Version20200616182630 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card_credentials ADD firstname VARCHAR(255) NOT NULL, ADD lastname VARCHAR(255) NOT NULL, CHANGE card_numbers card_numbers BIGINT NOT NULL, CHANGE ccv ccv INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE address_billing CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE address_shipping CHANGE user_id user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE card_credentials DROP firstname, DROP lastname, CHANGE card_numbers card_numbers INT NOT NULL, CHANGE ccv ccv INT DEFAULT NULL');
