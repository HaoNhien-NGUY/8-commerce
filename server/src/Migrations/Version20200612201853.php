 ...
 */
final class Version20200612201853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_order (id INT AUTO_INCREMENT NOT NULL, address_shipping_id INT NOT NULL, address_billing_id INT NOT NULL, status VARCHAR(255) NOT NULL, tracking_number VARCHAR(255) NOT NULL, packaging TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_17EB68C05F48D033 (address_shipping_id), INDEX IDX_17EB68C0439FD419 (address_billing_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
